...
const BookDetail = () => {
  ...
  const id: string = "61fd50778fdf4d4cada9ccf2";
  ...
  useEffect(() => {
    const fetchBookDetail = async () => {
      ...
      if (!res?.data?.success) return <div>Something is wrong</div>;
    };
    fetchBookDetail();
  }, [bookDetail, setBookDetail, slug]);
    ...
    <div className="container ">
      <div className="flex gap-x-5 ">
        ...
        <article className="w-3/6">
          ...
          <h5 className='my-2' >Rok vydania: <strong>{bookDetail?.yearOfRelease}</strong></h5>
